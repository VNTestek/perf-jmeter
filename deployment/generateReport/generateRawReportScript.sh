...
java -jar deployment/generateReport/ExportAggregateReport-1.0.jar "res/${resFol}/${timestamp}-res-convert"

# Copy the res folder to the saved folder
cp -r res/${resFol} ${savedReport}
echo "Copy to the saved folder successfully res/${resFol}"
